...
import { ChakraProvider, extendTheme, Box, Text, VStack, Link, Container, Flex, useBreakpointValue, Button } from '@chakra-ui/react';
    ...
    <ChakraProvider theme={theme}>
      <Box bg="brand.100" color="brand.900" fontFamily="body">
        <Container maxW="container.xl" py={5}>
          <Header visitCount={visitCount} likeCount={likeCount} onLike={handleLike} />
          <Showcase />
          <TopSections />
          <SkillsSection />
          <ContactSection />
...
const Header = ({ visitCount, likeCount, onLike }) => (
  <Box bg="brand.500" color="white" py="4" textAlign="center" position="relative">
    ...
    <Box position="absolute" top="4" right="4" textAlign="right">
      ...
      <Button onClick={onLike} colorScheme="red" size="sm">좋아요</Button>
    </Box>
  </Box>
);
